...
static ESIF_INLINE esif_primitive_type_t esif_primitive_type_set2get(esif_primitive_type_t type)
{
	...
	esif_primitive_type_map[] = {
		...
		{ SET_AUTONOMOUS_BATTERY_LIFE_MANAGEMENT_STATE, GET_AUTONOMOUS_BATTERY_LIFE_MANAGEMENT_STATE },
		...
		{ SET_PERF_PREFERENCE_MAX_SUR, GET_PERF_PREFERENCE_MAX_SUR },
		{ SET_PERF_PREFERENCE_MIN, GET_PERF_PREFERENCE_MIN },
		{ SET_PERF_PREFERENCE_MIN_SUR, GET_PERF_PREFERENCE_MIN_SUR },
	};
...
static ESIF_INLINE esif_primitive_type_t esif_primitive_type_get2set(esif_primitive_type_t type)
{
	...
	esif_primitive_type_map[] = {
		...
		{ GET_AUTONOMOUS_BATTERY_LIFE_MANAGEMENT_STATE, SET_AUTONOMOUS_BATTERY_LIFE_MANAGEMENT_STATE },
		...
		{ GET_PERF_PREFERENCE_MAX_SUR, SET_PERF_PREFERENCE_MAX_SUR },
		{ GET_PERF_PREFERENCE_MIN, SET_PERF_PREFERENCE_MIN },
		{ GET_PERF_PREFERENCE_MIN_SUR, SET_PERF_PREFERENCE_MIN_SUR },
	};
