...
static ESIF_INLINE esif_primitive_type_t esif_primitive_type_set2get(esif_primitive_type_t type)
{
	...
	esif_primitive_type_map[] = {
		...
		{ SET_EXTENDED_WORKLOAD_PREDICTION_BURST_MAX_THRESHOLD, GET_EXTENDED_WORKLOAD_PREDICTION_BURST_MAX_THRESHOLD },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_BURST_MIN_THRESHOLD, GET_EXTENDED_WORKLOAD_PREDICTION_BURST_MIN_THRESHOLD },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_BURST_TAU, GET_EXTENDED_WORKLOAD_PREDICTION_BURST_TAU },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_DEFAULT_HYST_TIME, GET_EXTENDED_WORKLOAD_PREDICTION_DEFAULT_HYST_TIME },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_PERF_HYST_TIME, GET_EXTENDED_WORKLOAD_PREDICTION_PERF_HYST_TIME },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MAX_THRESHOLD, GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MAX_THRESHOLD },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MIN_THRESHOLD, GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MIN_THRESHOLD },
		{ SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_TAU, GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_TAU },
...
static ESIF_INLINE esif_primitive_type_t esif_primitive_type_get2set(esif_primitive_type_t type)
{
	...
	esif_primitive_type_map[] = {
		...
		{ GET_EXTENDED_WORKLOAD_PREDICTION_BURST_MAX_THRESHOLD, SET_EXTENDED_WORKLOAD_PREDICTION_BURST_MAX_THRESHOLD },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_BURST_MIN_THRESHOLD, SET_EXTENDED_WORKLOAD_PREDICTION_BURST_MIN_THRESHOLD },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_BURST_TAU, SET_EXTENDED_WORKLOAD_PREDICTION_BURST_TAU },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_DEFAULT_HYST_TIME, SET_EXTENDED_WORKLOAD_PREDICTION_DEFAULT_HYST_TIME },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_PERF_HYST_TIME, SET_EXTENDED_WORKLOAD_PREDICTION_PERF_HYST_TIME },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MAX_THRESHOLD, SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MAX_THRESHOLD },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MIN_THRESHOLD, SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_MIN_THRESHOLD },
		{ GET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_TAU, SET_EXTENDED_WORKLOAD_PREDICTION_SUSTAINED_TAU },
