...
#
H,"dpf_dptf",1,0,"DPTF Manager Device","A6866C8E-0486-4797-9EA4-BBDF87DEA95D",0,"INT3400","","","","","","","","","","","",""
#
...
E,"PCAP",0x9164DC81-2A6F-4AC4-900A-0D230912A609,11,4,24,0x9091810C-F301-44D6-B2B5-B301812E4D08
E,"PSVT",0x86,24,3,24,0x661C68E1-B73E-4D02-859B-F1C1505F90D1
E,"RES",0x0BAE2EC5-F622-4010-BB29-F808AD4295C9,6,4,24,0xAB3E045F-6B51-4EC5-9330-EAB70836F02F
...
E,"SSOC",0xCA267DF9-852E-4A29-BCCF-23652611004B,27,2,41,0x164B8FD7-C165-4C86-8E9B-4464B6EEC015
E,"SSP",0x4E6EF634-C007-4AD9-BBB4-EC8A12F0F1CB,5,4,24,0x547F7465-D98A-40FD-AC12-E6D20F7B091B
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_art",,,
A,1,4,True,"_ART",,,,
#
# GET_CURRENT_LOW_POWER_MODE
#
P,94,255,1,24,"<schema></schema>",3,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/clpm",,,
A,1,4,True,"CLPM",,,,
#
...
A,0,20,False,"OVERRIDE","/participants/%nm%/lpmt",,,
A,1,4,True,"LPMT",,,,
#
...
# GET_PDR_TABLE
#
P,239,255,1,24,"<schema></schema>",7,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/pdrt",,,
A,1,4,True,"PDRT",,,,
#
# GET_SUPPORTED_POLICIES
#
P,92,255,1,24,"<schema></schema>",7,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/idsp",,,
A,1,4,True,"IDSP",,,,
#
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_trt",,,
A,1,4,True,"_TRT",,,,
#
...
# SET_PDR_TABLE
#
P,240,255,2,7,"<schema></schema>",24,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/pdrt",,,
#
