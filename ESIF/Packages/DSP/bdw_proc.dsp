...
#
H,"bdw_proc",1,0,"Broadwell Processor Device","C9194FB1-4F2C-4930-B352-5DCB2F37E325",1,"","","","","0x8086","0x1603","","","","","","",""
T,1,6,,,1,8
T,2,6,,,3,8
T,4,5,,,0,8
T,22,7,100,,3,8
...
A,0,20,False,"OVERRIDE","/participants/%nm%/ppcc",,,
A,1,4,True,"PPCC",,,,
#
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_tmp",,,
#
# SET_TEMPERATURE_INTERRUPT_STATE
#
P,280,0,2,3,"<schema></schema>",24,"<schema></schema>"
A,0,2,True,0x5820,15,15,,
#
# SET_TEMPERATURE_INTERRUPT_STATE
#
P,280,1,2,3,"<schema></schema>",24,"<schema></schema>"
A,0,2,True,0x5820,23,23,,
#
# SET_TEMPERATURE_THRESHOLDS
#
P,47,0,2,6,"<schema></schema>",24,"<schema></schema>"
A,0,29,True,"STT0",,,,
A,1,48,True,0x5820,14,8,,
#
# SET_TEMPERATURE_THRESHOLDS
#
P,47,1,2,6,"<schema></schema>",24,"<schema></schema>"
A,0,29,True,"STT1",,,,
A,1,48,True,0x5820,22,16,,
#
...
C,0x3B4 ,0x0,0x0,0x1,0x0,0x1,0x2,0x0,0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0
#
#
# GET_DOMAIN_PRIORITY
#
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_pdl",,,
A,1,4,True,"_PDL",,,,
#
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_tdl",,,
A,1,4,True,"_TDL",,,,
#
# GET_RAPL_ENERGY
#
...
#
P,277,0,1,24,"<schema></schema>",3,"<schema></schema>"
A,0,2,True,0x5998,7,0,,
#
# GET_PROC_RP_STATE_CAPABILITY
#
P,277,1,1,24,"<schema></schema>",3,"<schema></schema>"
A,0,2,True,0x5998,15,8,,
#
# GET_PROC_RP_STATE_CAPABILITY
#
P,277,2,1,24,"<schema></schema>",3,"<schema></schema>"
A,0,2,True,0x5998,23,16,,
#
# GET_RAPL_ENERGY
#
P,128,255,1,24,"<schema></schema>",3,"<schema></schema>"
...
# SET_GFX_RPCP
#
P,281,255,2,3,"<schema></schema>",24,"<schema></schema>"
A,0,2,True,0x5994,7,0,,
#
# SET_PERF_PRESENT_CAPABILITY
#
P,82,255,2,3,"<schema></schema>",24,"<schema></schema>"
