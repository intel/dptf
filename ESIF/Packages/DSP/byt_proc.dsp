...
#
H,"byt_proc",1,0,"ACPI Processor Device","6A77E67D-B0EB-4F86-8EAF-DCBED150A62D",0,"INT3401","","","","","","","","","","","",""
T,1,6,,,1,8
T,4,5,,,0,8
T,22,10,90,,12,8
T,29,6,,,1,8
...
A,0,20,False,"OVERRIDE","/participants/%nm%/_crt",,,
A,1,4,True,"_CRT",,,,
#
# GET_TRIP_POINT_HOT
#
P,12,255,1,24,"<schema></schema>",6,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/_hot",,,
A,1,4,True,"_HOT",,,,
#
# GET_TRIP_POINT_PASSIVE
#
P,11,255,1,24,"<schema></schema>",6,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/_psv",,,
A,1,4,True,"_PSV",,,,
#
# GET_TRIP_POINT_WARM
#
P,177,255,1,24,"<schema></schema>",6,"<schema></schema>"
A,0,20,False,"OVERRIDE","/participants/%nm%/_cr3",,,
A,1,4,True,"_CR3",,,,
#
# SET_COOLING_POLICY
#
...
C,0x3B0 ,0x0,0x0,0x0,0x0,0x1,0x2,0x0,0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0
#
#
# GET_DOMAIN_PRIORITY
#
