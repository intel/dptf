...
static ESIF_INLINE AuthAclDef AuthMgr_GetAuthAclDef(esif_handle_t authHandle)
{
	...
	case IPFAUTH_ROLE_PUBLIC:
	{
		...
		static AclPrimitive public_Primitive[] = {
			...
			{ ACL_PERMIT,	GET_EFFECTIVE_RAPL_POWER_LIMIT  },
			{ ACL_PERMIT,	GET_EFFECTIVE_RAPL_POWER_LIMIT_LOCK },
			{ ACL_PERMIT,	GET_EFFECTIVE_RAPL_POWER_LIMIT_TIME_WINDOW  },
			{ ACL_PERMIT,	GET_EFFECTIVE_RAPL_POWER_MAX },
			{ ACL_PERMIT,	GET_EFFECTIVE_RAPL_POWER_MIN },
			{ ACL_PERMIT,	GET_EIST_ENABLE },
			{ ACL_PERMIT,	GET_ENGINEERING_SAMPLE },
			{ ACL_PERMIT,	GET_FAN_INFORMATION },
			{ ACL_PERMIT,	GET_FAN_PERFORMANCE_STATES },
			{ ACL_PERMIT,	GET_FAN_STATUS },
			{ ACL_PERMIT,	GET_GEAR_MODE_MC0_CH0 },
			{ ACL_PERMIT,	GET_GEAR_MODE_MC0_CH1 },
			{ ACL_PERMIT,	GET_GEAR_MODE_MC1_CH0 },
			{ ACL_PERMIT,	GET_GEAR_MODE_MC1_CH1 },
			{ ACL_PERMIT,	GET_GRAPHICS_TCC_OFFSET },
			{ ACL_PERMIT,	GET_GRAPHICS_TEMP_VALID },
			{ ACL_PERMIT,	GET_GT_CLIP_REASONS },
			...
			{ ACL_PERMIT,	GET_HWP_INTERRUPT_ENABLED },
			...
			{ ACL_PERMIT,	GET_IA32_FIXED_CTR_CTRL },
			{ ACL_PERMIT,	GET_IA32_PERF_GLOBAL_CTRL },
			{ ACL_PERMIT,	GET_LAST_HID_SOURCE_LOCATION },
			{ ACL_PERMIT,	GET_MAX_EFFICIENCY_RATIO },
			{ ACL_PERMIT,	GET_MAX_NON_TURBO_RATIO },
			{ ACL_PERMIT,	GET_MEMORY_SPEED },
			{ ACL_PERMIT,	GET_MEMORY_GEAR_MULTIPLIER },
			{ ACL_PERMIT,	GET_MEMORY_GEAR_TYPE },
			{ ACL_PERMIT,	GET_MEMORY_QCLK_CURRENT_IDX },
			{ ACL_PERMIT,	GET_MEMORY_QCLK_FREQUENCY },
			{ ACL_PERMIT,	GET_MEMORY_TEMPERATURE_MULTIPLIER },
			{ ACL_PERMIT,	GET_MEMORY_TYPE },
			{ ACL_PERMIT,	GET_MICROCODE_UPDATE },
			{ ACL_PERMIT,	GET_NUM_CONFIG_TDP_LEVELS },
			{ ACL_PERMIT,	GET_PARTICIPANT_FRIENDLY_NAME },
			{ ACL_PERMIT,	GET_PARTICIPANT_TYPE },
			{ ACL_PERMIT,	GET_PER_CORE_FIXED_CTR1 },
			{ ACL_PERMIT,	GET_PER_CORE_FIXED_CTR2 },
			{ ACL_PERMIT,	GET_PER_CORE_TARGET_PSTATE },
			{ ACL_PERMIT,	GET_PER_CORE_TEMPERATURE },
			{ ACL_PERMIT,	GET_PERF_PREFERENCE_MAX },
			{ ACL_PERMIT,	GET_PERF_PREFERENCE_MIN },
			{ ACL_PERMIT,	GET_PERF_PRESENT_CAPABILITY },
			{ ACL_PERMIT,	GET_PERF_PSTATE_DEPTH_LIMIT },
			{ ACL_PERMIT,	GET_PKG_TIME_LIMIT_MAX },
			...
			{ ACL_PERMIT,	GET_POWER_LIMIT_ENABLE },
			{ ACL_PERMIT,	GET_PROC_HWP_ENABLE },
			{ ACL_PERMIT,	GET_PROC_HWP_SUPPORT_CHECK  },
			{ ACL_PERMIT,	GET_PROC_LOGICAL_PROCESSOR_COUNT },
			{ ACL_PERMIT,	GET_PROC_PHYSICAL_CORE_COUNT },
			{ ACL_PERMIT,	GET_PROC_RP_STATE_CAPABILITY },
			...
			{ ACL_PERMIT,	GET_RAPL_POWER_LIMIT_LOCK },
			{ ACL_PERMIT,	GET_RAPL_POWER_LIMIT_TIME_WINDOW },
			{ ACL_PERMIT,	GET_RAPL_POWER_MAX },
			{ ACL_PERMIT,	GET_RAPL_POWER_MIN },
			{ ACL_PERMIT,	GET_RAPL_POWER_UNIT },
			{ ACL_PERMIT,	GET_RAPL_TIME_UNIT },
			{ ACL_PERMIT,	GET_RATIO_LIMIT_PROGRAMMABLE },
			{ ACL_PERMIT,	GET_SOC_DGPU_WEIGHTS },
			{ ACL_PERMIT,	GET_SOC_WORKLOAD },
			{ ACL_PERMIT,	GET_SYSTEM_AGENT_VOLTAGE },
			{ ACL_PERMIT,	GET_TCC_LOCK_STATUS },
			{ ACL_PERMIT,	GET_TCC_OFFSET },
			{ ACL_PERMIT,	GET_TCC_OFFSET_PROGRAM_STATUS },
			{ ACL_PERMIT,	GET_TEMPERATURE },
			{ ACL_PERMIT,	GET_TEMPERATURE_MULTIPLIER },
			{ ACL_PERMIT,	GET_TEMPERATURE_THRESHOLDS },
			{ ACL_PERMIT,	GET_THERM_STATUS_PMAX_LOG },
			{ ACL_PERMIT,	GET_THERM_STATUS_PROCHOT_LOG },
			{ ACL_PERMIT,	GET_THERM_STATUS_THERMAL_MONITOR_LOG },
			{ ACL_PERMIT,	GET_TURBO_GRAPHICS_PERF_STATUS },
			{ ACL_PERMIT,	GET_TURBO_MODE_DISABLE },
			{ 0 },
		};
		...
		static AclEvent public_Event[] = {
			...
			{ ACL_PERMIT,	FACE_ID_CAPABILITY_CHANGED },
			{ ACL_PERMIT,	LAST_HID_SOURCE_LOCATION_CHANGED },
			...
			{ ACL_PERMIT,	PLATFORM_USER_PRESENCE_WITH_ENROLLMENT_CHANGED },
			{ ACL_PERMIT,	SENSOR_MODE_CHANGED },
			{ ACL_PERMIT,	SENSOR_USER_PRESENCE_CHANGED },
			{ ACL_PERMIT,	SENSOR_USER_PRESENCE_WITH_ENROLLMENT_CHANGED },
	...
	case IPFAUTH_ROLE_ELEVATED:
	{
		...
		static AclPrimitive elevated_Primitive[] = {
			...
			{ ACL_PERMIT,	GET_TURBO_GRAPHICS_PERF_STATUS },
			{ ACL_PERMIT,	GET_TURBO_MODE_DISABLE },
			{ ACL_PERMIT,	SET_EFFECTIVE_RAPL_POWER_LIMIT  },
			{ ACL_PERMIT,	SET_EFFECTIVE_RAPL_POWER_LIMIT_TIME_WINDOW  },
			{ ACL_PERMIT,	SET_FAN_LEVEL },
			{ ACL_PERMIT,	SET_GT_CLIP_REASONS },
			{ ACL_PERMIT,	SET_IA_CLIP_REASONS },
			{ ACL_PERMIT,	SET_IA32_FIXED_CTR_CTRL },
			{ ACL_PERMIT,	SET_IA32_PERF_GLOBAL_CTRL },
			{ ACL_PERMIT,	SET_OS_BATTERY_PERCENTAGE },
			{ ACL_PERMIT,	SET_PER_CORE_TARGET_PSTATE },
			{ ACL_PERMIT,	SET_PERF_PREFERENCE_MAX },
			{ ACL_PERMIT,	SET_PERF_PREFERENCE_MIN },
			{ ACL_PERMIT,	SET_PERF_PRESENT_CAPABILITY },
			{ ACL_PERMIT,	SET_PERF_PRESENT_CAPABILITY_SUR },
			...
			{ ACL_PERMIT,	SET_THERM_STATUS_PMAX_LOG },
			{ ACL_PERMIT,	SET_THERM_STATUS_PROCHOT_LOG },
			{ ACL_PERMIT,	SET_THERM_STATUS_THERMAL_MONITOR_LOG },
			{ 0 },
		};
	...
	case IPFAUTH_ROLE_DPTF:
	{
		...
		static AclPrimitive dptf_Primitive[] = {
			...
			{ ACL_PERMIT,	GET_CPU_OPBOOST_ENABLE_AC },
			{ ACL_PERMIT,	GET_CPU_OPBOOST_ENABLE_DC },
			...
			{ ACL_PERMIT,	GET_GPU_OPBOOST_ENABLE_AC },
			{ ACL_PERMIT,	GET_GPU_OPBOOST_ENABLE_DC },
			{ ACL_PERMIT,	GET_GPU_SPLIT_RATIO },
			{ ACL_PERMIT,	GET_GPU_SPLIT_RATIO_ACTIVE },
			{ ACL_PERMIT,	GET_GPU_SPLIT_RATIO_MAX },
			...
			{ ACL_PERMIT,	GET_POWER_LIMIT_SKU_MAX_AC },
			{ ACL_PERMIT,	GET_POWER_LIMIT_SKU_MIN_AC },
			{ ACL_PERMIT,	GET_POWER_PERF_TUNING_DYN_SWITCHING },
			...
			{ ACL_PERMIT,	GET_RAPL_POWER_LIMIT_TIME_WINDOW },
			{ ACL_PERMIT,	GET_RAPL_POWER_MIN },
			{ ACL_PERMIT,	GET_RATED_POWER_LIMIT_AC },
			{ ACL_PERMIT,	GET_RATED_POWER_LIMIT_DC },
			{ ACL_PERMIT,	GET_RESERVED_TGP },
			...
			{ ACL_PERMIT,	GET_SOC_SYSTEM_USAGE_MODE },
			{ ACL_PERMIT,	GET_SOC_WORKLOAD },
			...
			{ ACL_PERMIT,	SET_CPU_OPBOOST_ENABLE_AC },
			{ ACL_PERMIT,	SET_CPU_OPBOOST_ENABLE_DC },
			...
			{ ACL_PERMIT,	SET_GPU_OPBOOST_ENABLE_AC },
			{ ACL_PERMIT,	SET_GPU_OPBOOST_ENABLE_DC },
			{ ACL_PERMIT,	SET_GPU_SPLIT_RATIO },
			{ ACL_PERMIT,	SET_GPU_SPLIT_RATIO_MAX },
			...
			{ ACL_PERMIT,	SET_POWER_PERF_TUNING_DYN_SWITCHING },
			...
			{ ACL_PERMIT,	SET_SOC_SYSTEM_USAGE_MODE },
		...
		static AclEvent dptf_Event[] = {
			...
			{ ACL_PERMIT,	IP_ALIGNMENT_STATUS },
			{ ACL_PERMIT,	LAST_HID_SOURCE_LOCATION_CHANGED },
			{ ACL_PERMIT,	LOG_VERBOSITY_CHANGED },
			{ ACL_PERMIT,	MAX_BATTERY_POWER_CHANGED },
			{ ACL_PERMIT,	MOTION_CHANGED },
			{ ACL_PERMIT,	OEM_VARS_CHANGED },
			{ ACL_PERMIT,	OPPORTUNISTIC_BOOST_MODE_CHANGED },
			{ ACL_PERMIT,	OS_BATTERY_PERCENT_CHANGED },
			{ ACL_PERMIT,	OS_DOCK_MODE_CHANGED },
			{ ACL_PERMIT,	OS_GAME_MODE_CHANGED },
			{ ACL_PERMIT,	OS_LID_STATE_CHANGED },
			...
			{ ACL_PERMIT,	RESERVED_TGP_CHANGED },
	...
	// XTU Role = Intel Extreme Tuning Utility (XTU) Provider
	case IPFAUTH_ROLE_XTU:
	{
		// Authorized ESIF Interface Parameters for XTU Role
		static AclConfig xtu_GetConfig[] = {
			{ 0 },	// Deny All
		};
		static AclConfig xtu_SetConfig[] = {
			{ 0 },	// Deny All
		};
		static AclPrimitive xtu_Primitive[] = {
			{ ACL_PERMIT,	GET_CPU_REFERENCE_CLOCK_FREQUENCY },
			{ ACL_PERMIT,	GET_EFFICIENT_CORE_TRL_RANGE },
			{ ACL_PERMIT,	GET_EFFICIENT_CORE_TURBO_RATIO },
			{ ACL_PERMIT,	GET_ENERGY_EFFICIENCY_TURBO },
//			{ ACL_PERMIT,	GET_GEAR_TYPE },
			{ ACL_PERMIT,	GET_IA_OVERCLOCKING_STATUS },
			{ ACL_PERMIT,	GET_MEMORY_TIMINGS_OC_ENABLED },
			{ ACL_PERMIT,	GET_OC_BIOS_MBOX_CMD_REG },
			{ ACL_PERMIT,	GET_OC_BIOS_MBOX_DATA_REG },
			{ ACL_PERMIT,	GET_OC_MBOX },
			{ ACL_PERMIT,	GET_OVERCLOCKING_BINS_SUPPORTED },
			{ ACL_PERMIT,	GET_OVERCLOCKING_LOCK },
			{ ACL_PERMIT,	GET_PER_CORE_DESIRED_PERFORMANCE },
			{ ACL_PERMIT,	GET_PER_CORE_MAX_PERFORMANCE },
			{ ACL_PERMIT,	GET_PER_CORE_TARGET_RATIO },
			{ ACL_PERMIT,	GET_PER_CORE_VOLTAGE },
//			{ ACL_PERMIT,	GET_QCLK_CURRENT_IDX },
			{ ACL_PERMIT,	GET_SAGV_CONFIGURATION },
			{ ACL_PERMIT,	GET_SOC_REFERENCE_CLOCK_FREQUENCY },
			{ ACL_PERMIT,	GET_SOFT_STRAP_3_LOW },
			{ ACL_PERMIT,	GET_TRL_RANGE },
			{ ACL_PERMIT,	GET_TURBO_RATIO },
			{ ACL_PERMIT,	GET_UNCORE_CURRENT_RATIO },
			{ ACL_PERMIT,	GET_UNCORE_MAX_RATIO },
			{ ACL_PERMIT,	GET_UNCORE_MIN_RATIO },
			{ ACL_PERMIT,	GET_UNDERVOLT_PROTECTION_STATUS },
			{ ACL_PERMIT,	SET_EFFICIENT_CORE_TRL_RANGE },
			{ ACL_PERMIT,	SET_EFFICIENT_CORE_TURBO_RATIO },
			{ ACL_PERMIT,	SET_ENERGY_EFFICIENCY_TURBO },
			{ ACL_PERMIT,	SET_OC_BIOS_MBOX_CMD_REG },
			{ ACL_PERMIT,	SET_OC_BIOS_MBOX_DATA_REG },
			{ ACL_PERMIT,	SET_PER_CORE_DESIRED_PERFORMANCE },
			{ ACL_PERMIT,	SET_PER_CORE_MAX_PERFORMANCE },
			{ ACL_PERMIT,	SET_SAGV_CONFIGURATION },
			{ ACL_PERMIT,	SET_TRL_RANGE },
			{ ACL_PERMIT,	SET_TURBO_RATIO },
			{ ACL_PERMIT,	SET_UNCORE_MAX_RATIO },
			{ ACL_PERMIT,	SET_UNCORE_MIN_RATIO },
			{ 0 },
		};
		static AclWriteLog xtu_WriteLog[] = {
			{ ACL_PERMIT,	eLogTypeFatal,	eLogTypeDebug }, // Permit All
			{ 0 },
		};
		static AclEvent xtu_Event[] = {
			{ 0 },
		};
		static AclEvent xtu_EventSend[] = {
			{ 0 },
		};
		static AclCommand xtu_Command[] = {
			{ 0 },
		};
		AuthAclDef xtuAuth = {
			.name = "xtu",
			.EsifGetConfig = xtu_GetConfig,
			.EsifSetConfig = xtu_SetConfig,
			.EsifPrimitive = xtu_Primitive,
			.EsifWriteLog = xtu_WriteLog,
			.EsifEventRegister = xtu_Event,
			.EsifEventUnregister = xtu_Event,
			.EsifSendEvent = xtu_EventSend,
			.EsifSendCommand = xtu_Command,
		};
		authDef = xtuAuth;
		break;
	}
