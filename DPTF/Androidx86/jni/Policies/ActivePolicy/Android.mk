...
LOCAL_C_INCLUDES := \
	...
	$(DPTF_INC)/Policies/ActivePolicy \
	$(DPTF_INC)/ThirdParty

LOCAL_CFLAGS += -std=c++11 -fexceptions -frtti -Wall -fPIC \
	-DESIF_ATTR_OS_ANDROID -DESIF_ATTR_USER \
	-Wno-error=non-virtual-dtor -Wno-non-virtual-dtor -Wno-ignored-qualifiers -Wno-unused-parameter
...
FILE_LIST := $(wildcard $(LOCAL_PATH)/$(DPTF_SRC)/Policies/ActivePolicy/*.cpp)
