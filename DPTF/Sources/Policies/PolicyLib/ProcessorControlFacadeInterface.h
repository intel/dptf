...
class dptf_export ProcessorControlFacadeInterface
{
public:
	virtual ~ProcessorControlFacadeInterface() {};

	virtual Bool supportsProcessorControl(void) const = 0;
	virtual Bool setTccOffsetTemperature(const Temperature& tccOffset) = 0;
	...
	virtual Bool setSocGear(SocGear::Type gear) = 0;
	virtual SystemUsageMode::Type getSocSystemUsageMode() = 0;
	virtual Bool setSocSystemUsageMode(SystemUsageMode::Type mode) = 0;
};