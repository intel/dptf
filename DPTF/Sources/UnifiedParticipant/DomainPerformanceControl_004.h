...
class DomainPerformanceControl_004 : public DomainPerformanceControlBase
{
public:
	DomainPerformanceControl_004(
		UIntN participantIndex,
		UIntN domainIndex,
		const std::shared_ptr<ParticipantServicesInterface>& participantServicesInterface);
	~DomainPerformanceControl_004() override;

	// remove the copy constructor and = operator
	DomainPerformanceControl_004(const DomainPerformanceControl_004& rhs) = delete;
	DomainPerformanceControl_004& operator=(const DomainPerformanceControl_004& rhs) = delete;
