...
DomainRfProfileControl_002::DomainRfProfileControl_002(
...
DomainRfProfileControl_002::~DomainRfProfileControl_002(void)
{
}

RfProfileCapabilities DomainRfProfileControl_002::getRfProfileCapabilities(UIntN participantIndex, UIntN domainIndex)
{
...
void DomainRfProfileControl_002::setRfProfileCenterFrequency(
	UIntN participantIndex,
	UIntN domainIndex,
...
void DomainRfProfileControl_002::sendActivityLoggingDataIfEnabled(UIntN participantIndex, UIntN domainIndex)
{
	try
	{
...
void DomainRfProfileControl_002::onClearCachedData(void)
{
	// FIXME: do we clear the cache for this control?
}

std::shared_ptr<XmlNode> DomainRfProfileControl_002::getXml(UIntN domainIndex)
{
...
std::string DomainRfProfileControl_002::getName(void)
{
	return "RF Profile Control";
}

Percentage DomainRfProfileControl_002::getSscBaselineSpreadValue(UIntN participantIndex, UIntN domainIndex)
{
...
Percentage DomainRfProfileControl_002::getSscBaselineThreshold(UIntN participantIndex, UIntN domainIndex)
{
...
Percentage DomainRfProfileControl_002::getSscBaselineGuardBand(UIntN participantIndex, UIntN domainIndex)
{
