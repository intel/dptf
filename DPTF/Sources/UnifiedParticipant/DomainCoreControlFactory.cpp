...
DomainCoreControlInterface* DomainCoreControlFactory::createDomainCoreControlObject(
    UIntN version, ParticipantServicesInterface* participantServicesInterface)
{
    switch (version)
    {
        case 0:
            return new DomainCoreControl_000(participantServicesInterface);
            break;
        case 1:
            return new DomainCoreControl_001(participantServicesInterface);
            break;
        default:
