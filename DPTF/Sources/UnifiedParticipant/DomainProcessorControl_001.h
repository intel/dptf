...
class DomainProcessorControl_001 : public DomainProcessorControlBase
{
public:
	DomainProcessorControl_001(
...
private:
	...
	DomainProcessorControl_001(const DomainProcessorControl_001& rhs);
