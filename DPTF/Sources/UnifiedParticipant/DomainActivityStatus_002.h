...
class DomainActivityStatus_002 : public DomainActivityStatusBase
{
public:
	DomainActivityStatus_002(
		UIntN participantIndex,
		UIntN domainIndex,
		std::shared_ptr<ParticipantServicesInterface> participantServicesInterface);
	virtual ~DomainActivityStatus_002();
...
private:
	...
	DomainActivityStatus_002(const DomainActivityStatus_002& rhs);
	DomainActivityStatus_002& operator=(const DomainActivityStatus_002& rhs);
};
