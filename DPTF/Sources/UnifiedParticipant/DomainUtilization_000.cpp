...
DomainUtilization_000::DomainUtilization_000(ParticipantServicesInterface* participantServicesInterface)
{
...
XmlNode* DomainUtilization_000::getXml(UIntN domainIndex)
{
    throw not_implemented();
}