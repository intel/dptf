...
Power DomainPowerFilter::getMaxPowerChange(const PowerControlDynamicCaps& capabilities)
{
    ...
    Power maxPowerChange = (UInt32)(m_powerDelta[type].get() * (capabilities.getMaxPowerLimit() - capabilities.getMinPowerLimit()));
...
Power DomainPowerFilter::calculatePowerHigh(PowerControlType::Type type,
    Power currentPower, Power newEwmaPower)
{
...
Power DomainPowerFilter::calculatePowerLow(const PowerControlDynamicCaps& capabilities,
    Power currentPower, Power lastPowerUsed)
{
...
void DomainPowerFilter::updateHistory(PowerControlType::Type type,
    Power newPowerUsed, Power newEwmaPower)
{
