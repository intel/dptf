...
DomainPerformanceControl_004::~DomainPerformanceControl_004(void)
{
	restore();
}
	...
	UIntN performanceControlIndex)
{
	...
	try
	{
		...
		auto controlIdRequested = performanceControlSet[performanceControlIndex].getControlId();
...
void DomainPerformanceControl_004::onClearCachedData(void)
{
...
void DomainPerformanceControl_004::capture(void)
{
	try
	{
...
void DomainPerformanceControl_004::restore(void)
{
	if (m_initialStatus.isValid())
	{
		try
		{
			auto upperLimitIndex = m_initialStatus.get().getCurrentUpperLimitIndex();
			auto perfControlSet = getPerformanceControlSet(getParticipantIndex(), getDomainIndex());
			getParticipantServices()->primitiveExecuteSetAsUInt32(
...
PerformanceControlSet DomainPerformanceControl_004::createPerformanceControlSet(UIntN domainIndex)
{
	// Build PPSS table
...
std::string DomainPerformanceControl_004::getName(void)
{
	return "Control ID Performance Control";
}

void DomainPerformanceControl_004::setPerfPreferenceMax(
	UIntN participantIndex,
	UIntN domainIndex,
...
void DomainPerformanceControl_004::setPerfPreferenceMin(
	UIntN participantIndex,
	UIntN domainIndex,
	Percentage minMaxRatio)
{
