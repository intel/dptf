...
<table border="1">
  ...
  <tr>
    ...
    <td align='center' bgcolor="#FFFF99"><xsl:value-of select="min"/>-<xsl:value-of select="current"/>-<xsl:value-of select="max"/></td>
    </xsl:when>
    <xsl:otherwise>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <td align='center' colspan='4' bgcolor="#FFFF99">No Op: Take Default Action</td>
            </xsl:otherwise>
          </xsl:choose>
        </xsl:otherwise>
      </xsl:choose>
