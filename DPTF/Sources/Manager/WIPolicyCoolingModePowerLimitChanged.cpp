...
WIPolicyCoolingModePowerLimitChanged::~WIPolicyCoolingModePowerLimitChanged(void)
{
}
...
void WIPolicyCoolingModePowerLimitChanged::execute(void)
{
    ...
    for (UIntN i = 0; i < policyListCount; i++)
    {
        try
        {
            ...
            policy->executePolicyCoolingModePowerLimitChanged(m_powerLimit);
        }
        ...
        {
            WriteWorkItemErrorMessage_Function_Policy("Policy::executePolicyCoolingModePowerLimitChanged", i);
        }
    }
}