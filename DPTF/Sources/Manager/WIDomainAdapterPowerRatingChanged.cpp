...
WIDomainAdapterPowerRatingChanged::WIDomainAdapterPowerRatingChanged(
	...
	UIntN domainIndex)
	: DomainWorkItem(dptfManager, FrameworkEvent::Type::DomainAdapterPowerRatingChanged, participantIndex, domainIndex)
{
}

WIDomainAdapterPowerRatingChanged::~WIDomainAdapterPowerRatingChanged(void)
{
}

void WIDomainAdapterPowerRatingChanged::onExecute(void)
{
