...
WIDomainACPeakTimeWindowChanged::WIDomainACPeakTimeWindowChanged(
    DptfManagerInterface* dptfManager, UIntN participantIndex, UIntN domainIndex) :
    DomainWorkItem(dptfManager, FrameworkEvent::Type::DomainACPeakTimeWindowChanged, participantIndex, domainIndex)
{
}

WIDomainACPeakTimeWindowChanged::~WIDomainACPeakTimeWindowChanged(void)
{
}
