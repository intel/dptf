...
WIDomainACPeakPowerChanged::WIDomainACPeakPowerChanged(
    ...
    DomainWorkItem(dptfManager, FrameworkEvent::Type::DomainACPeakPowerChanged, participantIndex, domainIndex)
{
}

WIDomainACPeakPowerChanged::~WIDomainACPeakPowerChanged(void)
{
}
