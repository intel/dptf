...
class PolicyServicesDomainSystemPowerControl final : public PolicyServices, public DomainSystemPowerControlInterface
{
public:
	PolicyServicesDomainSystemPowerControl(DptfManagerInterface* dptfManager, UIntN policyIndex);
