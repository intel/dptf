...
WIDptfPolicyActivityLoggingDisabled::~WIDptfPolicyActivityLoggingDisabled(void)
{
}

void WIDptfPolicyActivityLoggingDisabled::onExecute(void)
{
	...
	for (auto i = policyIndexes.begin(); i != policyIndexes.end(); ++i)
	{
		try
		{
			...
			policy->executePolicyActivityLoggingDisabled();
		}
