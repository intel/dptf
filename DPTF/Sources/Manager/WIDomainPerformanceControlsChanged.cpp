...
WIDomainPerformanceControlsChanged::WIDomainPerformanceControlsChanged(
	...
	UIntN domainIndex)
	: DomainWorkItem(dptfManager, FrameworkEvent::Type::DomainPerformanceControlsChanged, participantIndex, domainIndex)
{
}

WIDomainPerformanceControlsChanged::~WIDomainPerformanceControlsChanged(void)
{
}

void WIDomainPerformanceControlsChanged::onExecute(void)
{
	writeDomainWorkItemStartingInfoMessage();

	try
	{
		getParticipantPtr()->domainPerformanceControlsChanged();
	}
	...
	for (auto i = policyIndexes.begin(); i != policyIndexes.end(); ++i)
	{
		try
		{
			...
			policy->executeDomainPerformanceControlsChanged(getParticipantIndex());
		}
