...
WIDomainEnergyThresholdCrossed::WIDomainEnergyThresholdCrossed(
	DptfManagerInterface* dptfManager,
	UIntN participantIndex,
	UIntN domainIndex)
	: DomainWorkItem(dptfManager, FrameworkEvent::DomainEnergyThresholdCrossed, participantIndex, domainIndex)
{
}

WIDomainEnergyThresholdCrossed::~WIDomainEnergyThresholdCrossed(void)
{
}

void WIDomainEnergyThresholdCrossed::onExecute(void)
{
