...
WIPolicyPowerBossMathTableChanged::~WIPolicyPowerBossMathTableChanged(void)
{
}

void WIPolicyPowerBossMathTableChanged::onExecute(void)
{
	...
	for (auto i = policyIndexes.begin(); i != policyIndexes.end(); ++i)
	{
		...
		{
			writeWorkItemErrorMessagePolicy(ex, "Policy::executePolicyPowerBossMathTableChanged", *i);
		}
	}
}
