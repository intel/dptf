...
class dptf_export ExportCommand : public CommandHandler
{
public:
	ExportCommand(DptfManagerInterface* dptfManager, const std::shared_ptr<IFileIo>& fileIo);
...
private:
	std::shared_ptr<CommandDispatcher> m_exportCommandDispatcher;
