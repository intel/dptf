...
WIPolicyPidAlgorithmTableChanged::~WIPolicyPidAlgorithmTableChanged(void)
{
}

void WIPolicyPidAlgorithmTableChanged::onExecute(void)
{
	...
	for (auto i = policyIndexes.begin(); i != policyIndexes.end(); ++i)
	{
		...
		{
			writeWorkItemErrorMessagePolicy(ex, "Policy::executePolicyPidAlgorithmTableChanged", *i);
		}
	}
}
