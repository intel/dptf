...
#define ENUM_ESIF_PARTICIPANT_ENUM(ENUM) \
    ...
    ENUM(ESIF_PARTICIPANT_ENUM_USB) \
    ENUM(ESIF_PARTICIPANT_ENUM_SYSFS)
...
#define CREATE_PARTICIPANT_ENUM(pe) case pe: str = #pe; break;
    ...
    switch(index) {
        ...
        CREATE_PARTICIPANT_ENUM(ESIF_PARTICIPANT_ENUM_USB)
        CREATE_PARTICIPANT_ENUM(ESIF_PARTICIPANT_ENUM_SYSFS)    }
    return str;
}
