...
typedef eEsifError (ESIF_CALLCONV *AppGetAboutFunction)       (esif::EsifDataPtr appAbout);
typedef eEsifError (ESIF_CALLCONV *AppGetDescriptionFunction) (esif::EsifDataPtr appDescription);
typedef eEsifError (ESIF_CALLCONV *AppGetGuidFunction)        (esif::EsifDataPtr appGuid);
typedef eEsifError (ESIF_CALLCONV *AppGetNameFunction)        (esif::EsifDataPtr appName);
typedef eEsifError (ESIF_CALLCONV *AppGetVersionFunction)     (esif::EsifDataPtr appVersion);
...
/* Suspend */
typedef eEsifError (ESIF_CALLCONV *AppSuspendFunction)(const void *appHandle);

/* Resume */
typedef eEsifError (ESIF_CALLCONV *AppResumeFunction)(const void *appHandle);
