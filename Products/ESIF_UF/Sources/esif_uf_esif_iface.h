...
/* Get Config */
typedef eEsifError (*AppGetConfigFunction)(const void *esifHandle,	/* ESIF provided constext handle */
...
/* Set Config */
typedef eEsifError (*AppSetConfigFunction)(const void *esifHandle,	/* ESIF provided context handle */
 ...
 */
typedef eEsifError (*AppPrimitiveFunction)(const void *esifHandle,	/* ESIF provided context handle */
										   const void *appHandle,			/* handled allocated by ESIF hosted application */
...
/* Write Log */
typedef eEsifError (*AppWriteLogFunction)(const void *esifHandle,	/* ESIF provided context handle */
...
/* Event Register */
typedef eEsifError (*AppEventRegisterFunction)(const void *esifHandle,	/* ESIF provided context handle */
											   const void *appHandle,			/* handle allocated by ESIF hosted application */
...
/* Event Unregister */
typedef eEsifError (*AppEventUnregisterFunction)(const void *esifHandle,/* ESIF provided context handle */
												 const void *appHandle,			/* handle allocated by ESIF hosted application */
