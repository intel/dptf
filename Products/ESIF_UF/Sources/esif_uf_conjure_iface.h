 ...
 */
typedef eEsifError (*RegisterParticipantFunction)(const EsifParticipantIfacePtr pi);

/*
    Upper Framework UnRegister Participant.  Provides the same functionality as the LF
    version.  Maybe called many times by one Conjure Library.
 */
typedef eEsifError (*UnRegisterParticipantFunction)(const EsifParticipantIfacePtr pi);
...
typedef eEsifError (*ConjureGetAboutFunction)(EsifDataPtr conjureAbout);
typedef eEsifError (*ConjureGetDescriptionFunction)(EsifDataPtr conjureDescription);
typedef eEsifError (*ConjureGetGuidFunction)(EsifDataPtr conjureGuid);
typedef eEsifError (*ConjureGetNameFunction)(EsifDataPtr conjureName);
typedef eEsifError (*ConjureGetVersionFunction)(EsifDataPtr conjureVersion);
