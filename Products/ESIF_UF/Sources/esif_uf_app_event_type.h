...
**
******************************************************************************/
#ifndef _ESIF_EVENT_TYPE_H_
#define _ESIF_EVENT_TYPE_H_

#include "esif.h"

#ifdef USE_GUID_EVENTS
#else
...
typedef enum _t_eAppEventType {
	...
	eEventAppPlatformLPMModChanged = 23,	/* Platform LPM Mode Changed */
	eEventAppPassiveTableChanged   = 24,	/* Passive Table Changed */
	...
	/* Reserved 18, 19, 20, 21 */

	/* GUID Event */
	eEventUUIDChanged = 22,	/* Generic Event GUID Defined */
