...
class PolicyServicesParticipantProperties final : public PolicyServices, public ParticipantPropertiesInterface
{
public:

    PolicyServicesParticipantProperties(DptfManager* dptfManager, UIntN policyIndex);
