...
#define CONNECTED_STANDBY_ENTRY {0xFD,0x34,0xF7,0x56,0xF7,0xB6,0x47,0xDD,0xB3,0xD5,0x00,0x11,0xA3,0x4E,0x43,0x37}

// Event Name:  CONNECTED_STANDBY_EXIT
// Event GUID:  9604508D-F4AA-4716-83D9-6EE951EBBEA9
// Event Desc:  Exit connected standby
#define CONNECTED_STANDBY_EXIT {0x96,0x04,0x50,0x8D,0xF4,0xAA,0x47,0x16,0x83,0xD9,0x6E,0xE9,0x51,0xEB,0xBE,0xA9}
...
#define ACTIVE_RELATIONSHIP_CHANGED {0xC7,0xC5,0xFC,0x88,0x8A,0xAC,0x42,0xC2,0x8B,0x51,0x21,0x77,0x70,0x33,0xE7,0x5D}
...
#define THERMAL_RELATIONSHIP_CHANGED {0x7E,0x99,0xE9,0x0E,0x0A,0x22,0x4E,0xEC,0xAD,0x6C,0x90,0x8D,0xEB,0x21,0xE9,0xA9}

// Event Name:  FOREGROUND_CHANGED
// Event GUID:  88E419E3-609B-4BDA-9A17-83DE899831FD
// Event Desc:  Foreground application changed
#define FOREGROUND_CHANGED {0x88,0xE4,0x19,0xE3,0x60,0x9B,0x4B,0xDA,0x9A,0x17,0x83,0xDE,0x89,0x98,0x31,0xFD}

// Event Name:  SUSPEND
// Event GUID:  547F7465-D98A-40FD-AC12-E6D20F7B091B
// Event Desc:  Suspend Upper Framework
#define SUSPEND {0x54,0x7F,0x74,0x65,0xD9,0x8A,0x40,0xFD,0xAC,0x12,0xE6,0xD2,0x0F,0x7B,0x09,0x1B}

// Event Name:  RESUME
// Event GUID:  AB3E045F-6B51-4EC5-9330-EAB70836F02F
// Event Desc:  Resume Upper Framework
#define RESUME {0xAB,0x3E,0x04,0x5F,0x6B,0x51,0x4E,0xC5,0x93,0x30,0xEA,0xB7,0x08,0x36,0xF0,0x2F}
...
#define CTDP_CAPABILITY_CHANGED {0x68,0xD1,0x6E,0x98,0x2C,0x89,0x4A,0x3D,0x95,0xC7,0x5D,0xEE,0xAA,0x4F,0xD7,0x3F}

// Event Name:  CORE_CAPABILITY_CHANGED
// Event GUID:  8487D740-62F7-4030-BE1A-C201377E0C18
// Event Desc:  For future use
#define CORE_CAPABILITY_CHANGED {0x84,0x87,0xD7,0x40,0x62,0xF7,0x40,0x30,0xBE,0x1A,0xC2,0x01,0x37,0x7E,0x0C,0x18}
...
#define DISPLAY_CAPABILITY_CHANGED {0xF1,0xCD,0xA3,0x38,0x0F,0x3C,0x4F,0x8D,0xA1,0xD9,0x80,0x33,0xE6,0x72,0xF6,0x72}

// Event Name:  DISPLAY_STATUS_CHANGED
// Event GUID:  BDB4F356-CF69-4152-99A9-1DCE4972AB9D
// Event Desc:  Current Display brightness status has changed due to a user or other override
#define DISPLAY_STATUS_CHANGED {0xBD,0xB4,0xF3,0x56,0xCF,0x69,0x41,0x52,0x99,0xA9,0x1D,0xCE,0x49,0x72,0xAB,0x9D}
...
#define PERF_CAPABILITY_CHANGED {0x90,0x91,0x81,0x0C,0xF3,0x01,0x44,0xD6,0xB2,0xB5,0xB3,0x01,0x81,0x2E,0x4D,0x08}

// Event Name:  PERF_CONTROL_CHANGED
// Event GUID:  D8B5EA17-5486-40FC-A0C6-2AE92AEB3775
// Event Desc:  For future use
#define PERF_CONTROL_CHANGED {0xD8,0xB5,0xEA,0x17,0x54,0x86,0x40,0xFC,0xA0,0xC6,0x2A,0xE9,0x2A,0xEB,0x37,0x75}
...
#define POWER_CAPABILITY_CHANGED {0x82,0xC4,0x38,0xDD,0x67,0x3B,0x46,0xA6,0x99,0x5F,0x24,0xCA,0xF4,0x64,0x4D,0xCF}
...
#define POWER_THRESHOLD_CROSSED {0x68,0x13,0x88,0x91,0xC2,0x25,0x43,0x8A,0x8F,0x43,0x04,0xB0,0x71,0xCB,0xF4,0xE3}

// Event Name:  PRIORITY_CHANGED
// Event GUID:  98077FF3-AD61-4E50-AFEE-51D0CE8DE396
// Event Desc:  Domain priority has changed
#define PRIORITY_CHANGED {0x98,0x07,0x7F,0xF3,0xAD,0x61,0x4E,0x50,0xAF,0xEE,0x51,0xD0,0xCE,0x8D,0xE3,0x96}

// Event Name:  TEMP_THRESHOLD_CROSSED
// Event GUID:  43CDD7D8-C96D-4EE7-9A4A-7EC5C2EE1B6E
// Event Desc:  Temperature Threshold Changed
#define TEMP_THRESHOLD_CROSSED {0x43,0xCD,0xD7,0xD8,0xC9,0x6D,0x4E,0xE7,0x9A,0x4A,0x7E,0xC5,0xC2,0xEE,0x1B,0x6E}
...
#define SPEC_INFO_CHANGED {0x75,0x49,0x4A,0x00,0x41,0x7C,0x4E,0x51,0x9F,0xAB,0xFB,0xDD,0x96,0x55,0x77,0xD4}

// Event Name:  CREATE
// Event GUID:  F3B70F0B-79BC-4414-BCF7-6389658E9FAB
// Event Desc:  Create Upper Framework (Participant)
#define CREATE {0xF3,0xB7,0x0F,0x0B,0x79,0xBC,0x44,0x14,0xBC,0xF7,0x63,0x89,0x65,0x8E,0x9F,0xAB}

// Event Name:  DESTROY
// Event GUID:  D58C6702-BB4E-4F82-87F9-E527FEBBBEE1
// Event Desc:  Destroy Upper Framework (Participant)
#define DESTROY {0xD5,0x8C,0x67,0x02,0xBB,0x4E,0x4F,0x82,0x87,0xF9,0xE5,0x27,0xFE,0xBB,0xBE,0xE1}

// Event Name:  SHUTDOWN
// Event GUID:  DE7CA990-66C6-4F0F-B78F-E2774E3CE790
// Event Desc:  Shutdown Upper Framework (Participant)
#define SHUTDOWN {0xDE,0x7C,0xA9,0x90,0x66,0xC6,0x4F,0x0F,0xB7,0x8F,0xE2,0x77,0x4E,0x3C,0xE7,0x90}

// Event Name:  ACPI
// Event GUID:  722610FF-EDA3-4FED-BEAE-B70290011287
// Event Desc:  ACPI Notify To ESIF Event Translation
#define ACPI {0x72,0x26,0x10,0xFF,0xED,0xA3,0x4F,0xED,0xBE,0xAE,0xB7,0x02,0x90,0x01,0x12,0x87}
...
#define COOLING_MODE_ACOUSTIC_LIMIT_CHANGED {0x0C,0xB6,0xC2,0xE2,0x32,0x42,0x40,0xFC,0x84,0x5F,0x17,0xF8,0x24,0xFB,0x85,0x7E}
...
#define COOLING_MODE_POWER_LIMIT_CHANGED {0xDB,0xF7,0xB2,0xCF,0x3B,0x16,0x47,0x73,0x9C,0xA9,0xDD,0x74,0xFF,0x91,0xD6,0xBF}

// Event Name:  OS_LPM_MODE_CHANGED
// Event GUID:  5569447B-6E8F-4FE2-94DE-C31DA011ECF7
// Event Desc:  OS LPM Changed
#define OS_LPM_MODE_CHANGED {0x55,0x69,0x44,0x7B,0x6E,0x8F,0x4F,0xE2,0x94,0xDE,0xC3,0x1D,0xA0,0x11,0xEC,0xF7}

// Event Name:  PASSIVE_TABLE_CHANGED
// Event GUID:  661C68E1-B73E-4D02-859B-F1C1505F90D1
// Event Desc:  PSV Object Changed
#define PASSIVE_TABLE_CHANGED {0x66,0x1C,0x68,0xE1,0xB7,0x3E,0x4D,0x02,0x85,0x9B,0xF1,0xC1,0x50,0x5F,0x90,0xD1}
...
#define SENSOR_ORIENTATION_CHANGED {0x01,0x9C,0x35,0x71,0x35,0x60,0x4E,0xC6,0xBD,0xED,0x88,0x4F,0x61,0x25,0xB5,0xF9}
...
#define SENSOR_SPATIAL_ORIENTATION_CHANGED {0x16,0x4B,0x8F,0xD7,0xC1,0x65,0x4C,0x86,0x8E,0x9B,0x44,0x64,0xB6,0xEE,0xC0,0x15}

// Event Name:  SENSOR_PROXIMITY_CHANGED
// Event GUID:  C7C83E34-519B-4650-A8B2-640E31F5BB0A
// Event Desc:  Sensor Proximity Changed
#define SENSOR_PROXIMITY_CHANGED {0xC7,0xC8,0x3E,0x34,0x51,0x9B,0x46,0x50,0xA8,0xB2,0x64,0x0E,0x31,0xF5,0xBB,0x0A}

// Event Name:  SYSTEM_COOLING_POLICY_CHANGED
// Event GUID:  5C7D591E-2EA8-4DA1-85A4-476191404650
// Event Desc:  System Cooling Policy
#define SYSTEM_COOLING_POLICY_CHANGED {0x5C,0x7D,0x59,0x1E,0x2E,0xA8,0x4D,0xA1,0x85,0xA4,0x47,0x61,0x91,0x40,0x46,0x50}

// Event Name:  LPM_MODE_CHANGED
// Event GUID:  DDADD3BF-2385-4E3B-B242-2793B81293AA
// Event Desc:  Non OS LPM Changed
#define LPM_MODE_CHANGED {0xDD,0xAD,0xD3,0xBF,0x23,0x85,0x4E,0x3B,0xB2,0x42,0x27,0x93,0xB8,0x12,0x93,0xAA}
...
#define OS_CTDP_CAPABILITY_CHANGED {0x07,0x02,0x9c,0xd8,0x46,0x64,0x46,0x98,0x95,0xd8,0x43,0xb2,0xe9,0x66,0x65,0x96}
