...
#define ENUM_ESIF_PRIMITIVE_TYPE(ENUM) \
    ...
    ENUM##_VAL(GET_CLOCK_SPREAD_DIRECTION,191) \
    ENUM##_VAL(GET_CLOCK_SPREAD_PERCENTAGE,190) \
    ENUM##_VAL(GET_CLOCK_SPREAD_SUBHARMONICS,192) \
    ENUM##_VAL(GET_CLOCK_SSC_DISABLED_FREQUENCY,189) \
    ENUM##_VAL(GET_CLOCK_SSC_ENABLED_FREQUENCY,188) \
    ...
    ENUM##_VAL(GET_DISPLAY_DEVIATION_DIRECTION,180) \
    ...
    ENUM##_VAL(GET_GRAPHICS_CHIPSET_PLL_TABLE,183) \
    ENUM##_VAL(GET_GRAPHICS_CHIPSET_SSC_ENABLED,184) \
    ENUM##_VAL(GET_LPM_TABLE,237) \
    ENUM##_VAL(GET_MEM_DEVICE_MCHBAR,73) \
    ENUM##_VAL(GET_MEM_DIMM_DDR_WIDTH,112) \
    ENUM##_VAL(GET_MEM_DIMM_NUMBER_OF_RANKS,114) \
    ENUM##_VAL(GET_MEM_DIMM_SELECT_BIT,115) \
    ENUM##_VAL(GET_MEM_DIMM_SIZE_256_MULT,117) \
    ENUM##_VAL(GET_MEM_DRAM_FREQUENCY,121) \
    ENUM##_VAL(GET_MEM_INTERLEAVE_ENHANCED_MODE,108) \
    ENUM##_VAL(GET_MEM_INTERLEAVE_HIGH_ORDER_ADDRESS,106) \
    ENUM##_VAL(GET_MEM_INTERLEAVE_HIGH_ORDER_RANK_STATUS,107) \
    ENUM##_VAL(GET_MEM_INTERLEAVE_RANK_BIT,110) \
    ENUM##_VAL(GET_MEM_PLL_REFERENCE_CLOCK_SETTING,120) \
    ...
    ENUM##_VAL(GET_PROC_FIVR_RFI_TUNING_AVAILABLE,210) \
    ...
    ENUM##_VAL(GET_PROC_PCODE_MBOX_DATA,213) \
    ENUM##_VAL(GET_PROC_PCODE_MBOX_IFACE,217) \
    ENUM##_VAL(GET_PROC_PCODE_MBOX_STATUS,215) \
    ...
    ENUM##_VAL(SET_PROC_FIVR_RFI_TUNING,211) \
    ENUM##_VAL(SET_PROC_IO_THROTTLE_CONTROL,152) \
    ENUM##_VAL(SET_PROC_LOGICAL_PROCESSOR_AFFINITY,229) \
    ENUM##_VAL(SET_PROC_PCODE_MBOX_DATA,212) \
    ENUM##_VAL(SET_PROC_PCODE_MBOX_IFACE,214) \
    ENUM##_VAL(SET_PROC_PCODE_MBOX_STATUS,216) \
...
enum esif_primitive_type {
    ...
    GET_CLOCK_SPREAD_DIRECTION=191,
    GET_CLOCK_SPREAD_PERCENTAGE=190,
    GET_CLOCK_SPREAD_SUBHARMONICS=192,
    GET_CLOCK_SSC_DISABLED_FREQUENCY=189,
    GET_CLOCK_SSC_ENABLED_FREQUENCY=188,
    ...
    GET_DISPLAY_DEVIATION_DIRECTION=180,
    ...
    GET_GRAPHICS_CHIPSET_PLL_TABLE=183,
    GET_GRAPHICS_CHIPSET_SSC_ENABLED=184,
    GET_LPM_TABLE=237,
    GET_MEM_DEVICE_MCHBAR=73,
    GET_MEM_DIMM_DDR_WIDTH=112,
    GET_MEM_DIMM_NUMBER_OF_RANKS=114,
    GET_MEM_DIMM_SELECT_BIT=115,
    GET_MEM_DIMM_SIZE_256_MULT=117,
    GET_MEM_DRAM_FREQUENCY=121,
    GET_MEM_INTERLEAVE_ENHANCED_MODE=108,
    GET_MEM_INTERLEAVE_HIGH_ORDER_ADDRESS=106,
    GET_MEM_INTERLEAVE_HIGH_ORDER_RANK_STATUS=107,
    GET_MEM_INTERLEAVE_RANK_BIT=110,
    GET_MEM_PLL_REFERENCE_CLOCK_SETTING=120,
    ...
    GET_PROC_FIVR_RFI_TUNING_AVAILABLE=210,
    ...
    GET_PROC_PCODE_MBOX_DATA=213,
    GET_PROC_PCODE_MBOX_IFACE=217,
    GET_PROC_PCODE_MBOX_STATUS=215,
    ...
    SET_PROC_FIVR_RFI_TUNING=211,
    SET_PROC_IO_THROTTLE_CONTROL=152,
    SET_PROC_LOGICAL_PROCESSOR_AFFINITY=229,
    SET_PROC_PCODE_MBOX_DATA=212,
    SET_PROC_PCODE_MBOX_IFACE=214,
    SET_PROC_PCODE_MBOX_STATUS=216,
...
{
#define CREATE_PRIMITIVE_TYPE(pt) case pt: str = (esif_string) #pt; break;
#define CREATE_PRIMITIVE_TYPE_VAL(pt,VAL) case pt: str = (esif_string) #pt; break;
    ...
    CREATE_PRIMITIVE_TYPE (GET_CLOCK_SPREAD_DIRECTION)
    CREATE_PRIMITIVE_TYPE (GET_CLOCK_SPREAD_PERCENTAGE)
    CREATE_PRIMITIVE_TYPE (GET_CLOCK_SPREAD_SUBHARMONICS)
    CREATE_PRIMITIVE_TYPE (GET_CLOCK_SSC_DISABLED_FREQUENCY)
    CREATE_PRIMITIVE_TYPE (GET_CLOCK_SSC_ENABLED_FREQUENCY)
    ...
    CREATE_PRIMITIVE_TYPE (GET_DISPLAY_DEVIATION_DIRECTION)
    ...
    CREATE_PRIMITIVE_TYPE (GET_GRAPHICS_CHIPSET_PLL_TABLE)
    CREATE_PRIMITIVE_TYPE (GET_GRAPHICS_CHIPSET_SSC_ENABLED)
    CREATE_PRIMITIVE_TYPE (GET_LPM_TABLE)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DEVICE_MCHBAR)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DIMM_DDR_WIDTH)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DIMM_NUMBER_OF_RANKS)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DIMM_SELECT_BIT)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DIMM_SIZE_256_MULT)
    CREATE_PRIMITIVE_TYPE (GET_MEM_DRAM_FREQUENCY)
    CREATE_PRIMITIVE_TYPE (GET_MEM_INTERLEAVE_ENHANCED_MODE)
    CREATE_PRIMITIVE_TYPE (GET_MEM_INTERLEAVE_HIGH_ORDER_ADDRESS)
    CREATE_PRIMITIVE_TYPE (GET_MEM_INTERLEAVE_HIGH_ORDER_RANK_STATUS)
    CREATE_PRIMITIVE_TYPE (GET_MEM_INTERLEAVE_RANK_BIT)
    CREATE_PRIMITIVE_TYPE (GET_MEM_PLL_REFERENCE_CLOCK_SETTING)
    ...
    CREATE_PRIMITIVE_TYPE (GET_PROC_FIVR_RFI_TUNING_AVAILABLE)
    ...
    CREATE_PRIMITIVE_TYPE (GET_PROC_PCODE_MBOX_DATA)
    CREATE_PRIMITIVE_TYPE (GET_PROC_PCODE_MBOX_IFACE)
    CREATE_PRIMITIVE_TYPE (GET_PROC_PCODE_MBOX_STATUS)
    ...
    CREATE_PRIMITIVE_TYPE (GET_SUPER_DEBUG)
    ...
    CREATE_PRIMITIVE_TYPE (SET_PROC_FIVR_RFI_TUNING)
    CREATE_PRIMITIVE_TYPE (SET_PROC_IO_THROTTLE_CONTROL)
    CREATE_PRIMITIVE_TYPE (SET_PROC_LOGICAL_PROCESSOR_AFFINITY)
    CREATE_PRIMITIVE_TYPE (SET_PROC_PCODE_MBOX_DATA)
    CREATE_PRIMITIVE_TYPE (SET_PROC_PCODE_MBOX_IFACE)
    CREATE_PRIMITIVE_TYPE (SET_PROC_PCODE_MBOX_STATUS)
