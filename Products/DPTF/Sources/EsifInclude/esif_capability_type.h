...
#define ENUM_ESIF_CAPABILITY_TYPE(ENUM) \
    ...
    ENUM##_VAL(ESIF_CAPABILITY_TYPE_FREQ_STATUS,10) \
    ENUM##_VAL(ESIF_CAPABILITY_TYPE_FREQ_CONTROL,11) \
...
enum esif_capability_type {
    ...
    ESIF_CAPABILITY_TYPE_FREQ_STATUS=10,
    ESIF_CAPABILITY_TYPE_FREQ_CONTROL=11,
...
#define CREATE_CAPABILITY_TYPE_VAL(ct,VAL) case ct: str = (esif_string) #ct; break;
    ...
    switch(type) {
        ...
        CREATE_CAPABILITY_TYPE (ESIF_CAPABILITY_TYPE_FREQ_STATUS)
        CREATE_CAPABILITY_TYPE (ESIF_CAPABILITY_TYPE_FREQ_CONTROL)
...
#define ESIF_CAPABILITY_FREQ_STATUS 0x400
#define ESIF_CAPABILITY_FREQ_CONTROL 0x800
