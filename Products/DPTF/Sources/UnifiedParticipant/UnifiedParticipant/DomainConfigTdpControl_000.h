...
class DomainConfigTdpControl_000 final : public DomainConfigTdpControlInterface,
    public ComponentExtendedInterface
{
public:

    DomainConfigTdpControl_000(ParticipantServicesInterface* participantServicesInterface);
