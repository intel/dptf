...
class ParticipantGetSpecificInfo_000 final : public ParticipantGetSpecificInfoInterface,
    public ComponentExtendedInterface
{
public:

    ParticipantGetSpecificInfo_000(ParticipantServicesInterface* participantServicesInterface);
