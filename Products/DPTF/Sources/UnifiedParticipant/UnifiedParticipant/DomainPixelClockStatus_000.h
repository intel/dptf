...
class DomainPixelClockStatus_000 final : public DomainPixelClockStatusInterface,
    public ComponentExtendedInterface
{
public:

    DomainPixelClockStatus_000(ParticipantServicesInterface* participantServicesInterface);
