...
class DomainRfProfileStatus_000 final : public DomainRfProfileStatusInterface,
    public ComponentExtendedInterface
{
public:

    DomainRfProfileStatus_000(ParticipantServicesInterface* participantServicesInterface);
